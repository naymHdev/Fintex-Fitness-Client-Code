    ...
    <div className="grid font-josefin grid-cols-1 md:grid-cols-2 mt-20 gap-44 p-12 bg-green-500 opacity-65 text-slate-100">
      <div className="">
        ...
        <p className="text-sm">
          ...
          skills, offering personalized training plans, nutrition guidance, and
          motivation. Achieve your fitness goals with our knowledgeable and
          supportive coaches leading the way.
        </p>
